...
OutFile bluecoin-1.2.0-win32-setup.exe
...
Section -post SEC0001
    ...
    CreateShortcut "$SMPROGRAMS\$StartMenuGroup\bluecoin.lnk" $INSTDIR\bluecoin-qt.exe
    CreateShortcut "$SMPROGRAMS\$StartMenuGroup\Uninstall bluecoin.lnk" $INSTDIR\uninstall.exe
...
Section -un.post UNSEC0001
    ...
    Delete /REBOOTOK "$SMPROGRAMS\$StartMenuGroup\Uninstall bluecoin.lnk"
    Delete /REBOOTOK "$SMPROGRAMS\$StartMenuGroup\bluecoin.lnk"
    Delete /REBOOTOK "$SMSTARTUP\bluecoin.lnk"
